...
def run():
    ...
    doc.add_paragraph(
        ...
        'WebRemote доступен в Professional и Enterprise. Ограничения по числу активов зависят от редакции и размера лицензии.'
    )
    doc.add_paragraph()
    ...
    for s in [
        ...
        'Учёт железа и ПО, управление лицензиями и соответствием.',
    ...
    doc.add_paragraph(
        ...
        'В редакции Standard нет управления активами и WebRemote (удалённый доступ к рабочим станциям).'
    )
    doc.add_paragraph()
    ...
    gloss = [
        ...
        ('WebRemote', 'Удалённый доступ к рабочим станциям из консоли (Professional и Enterprise).'),
